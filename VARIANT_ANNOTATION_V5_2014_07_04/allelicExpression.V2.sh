...
#JChiron CHANGE 2015-06-18
# add --separate option to report all transcripts annotation in exonic_variant_function file (ex CDKN2A chr9:21971136G>A only NM_058195 reported whereas our of interest is NM_000077 because on this variant mutation is synonymous, so annovar doesn't report it)
#/results/tools/annovar/annotate_variation.pl $hg --geneanno --hgvs --splicing_threshold 5 --separate $unionFile $annoDB &>> $annoLog || exit 21
