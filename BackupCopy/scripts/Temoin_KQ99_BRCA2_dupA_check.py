...
################################################################################
HD_names = ["Temoin_positif_Quellet","Temoin-positif-Quellet","TEMOIN-POSITIF-QUELLET","QUELLET-KQ99","QUELLET-TEMOIN","temoin-positif-Quellet"]
xls_path = "/media/PGM/suivi_temion_positif_KQ99_BRCA2_dupA.xls"
...
if barcode:
	...
	print "ERROR : KQ99 sample not found. aborting."
	exit()
