...
################################################################################
HD_names = ["Temoin_HD779","Temoin_HD779_EQ"]
xls_path = "/media/PGM/results_S5/suivi_temion_positif_ADNtc_horizon_HD779.xls"
		...
		if ctl_name in json_dat[ionxpress]['sample'] :
			...
			barcode = ionxpress
                        ...
                        if barcode:
                                ...
                                print "ERROR :  Temoin_HD779 sample not found. aborting."
                                exit()
