...
class BPER_oncomine(IonPlugin):
	...
	def launch(self):
		...
		cmd = 'echo ionadmin | sudo -u ionadmin -S rsync -r -t --rsync-path=\"mkdir -p /u02/MiSeq/test/error_rate_ctDNA/panel_oncomine/'+runRemote+' && rsync\" /media/PGM/results_S5/BPER/ADNtc_oncomine_focus/touch.txt genetique@129.10.20.36:/u02/MiSeq/test/error_rate_ctDNA/panel_oncomine/'+runRemote+'/.'
