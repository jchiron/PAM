        ...
        if(row_content[name2index["TRANSCRIPTS"]] != 'NA'):
            ...
            for transcript_data in transcripts.split(","):
                ...
                if(nm_data[0] == ref_nm):
                    ...
                    if(len(nm_data)>=3):
                    	if re.match("c\.[0-9]+-[0-9]+[ATCG]+",nm_data[2]): # nomenclature hgvs : rajout 'delins' quand absent
