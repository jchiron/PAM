...
def plugin_main():
    ...
    #manage many barcodes for one sample (oncomine has RNA and DNA barcode for same sample) = get DNA sample barcode
    ...
    block_content = "<!DOCTYPE html>\n" \
        ...
        "<body>\n" \
         ...
         "      <tr>\n" \
         "        <th><span class=\"help\" title=\"Barcode name\">Barcode ID</span></th>\n" \
